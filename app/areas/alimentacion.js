    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.back()}>
          <Ionicons name="arrow-back" size={24} color="#0b4905ff" />
        </TouchableOpacity>
        <Image
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          >
            <View style={styles.cardIconText}>
              <Ionicons name="restaurant-outline" size={28} color="#15860bff" />
        ...
        <View style={styles.card}>
          ...
          >
            <View style={styles.cardIconText}>
              <Ionicons name="nutrition-outline" size={28} color="#15860bff" />
        ...
        <View style={styles.card}>
          ...
          >
            <View style={styles.cardIconText}>
              <Ionicons name="fish-outline" size={28} color="#15860bff" />
